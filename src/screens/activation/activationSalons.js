...
export const normalizeActivationSalon = record => {
  ...
  const status = {QR_PENDING: 'QR Pending', TRAINING_PENDING: 'Training Pending', READY_ACTIVATION: 'Ready Activation', READY_FOR_ACTIVATION: 'Ready Activation'}[statusKey]
    || rawStatus;
