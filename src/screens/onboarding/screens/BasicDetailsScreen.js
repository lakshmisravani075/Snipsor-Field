...
const styles = StyleSheet.create({
  ...
  headerTitle: {flex: 1, color: '#FFFFFF', fontSize: 18, fontWeight: '600'},
  ...
  label: {color: '#202744', fontSize: 11, fontWeight: '600', marginBottom: 7, marginTop: 2}, required: {color: '#F04452'},
  ...
  input: {flex: 1, color: '#111735', fontSize: 11, paddingHorizontal: 10, paddingVertical: 0}, counter: {color: '#8A90A5', fontSize: 8, marginRight: 8},
