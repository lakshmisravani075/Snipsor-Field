...
const callButtonIcon = require('../../../assets/icons/onboarding-call.png');
const navigateButtonIcon = require('../../../assets/icons/onboarding-navigate.png');
...
const externalLinkIcon = require('../../../assets/icons/onboarding-external-link.png');
const playButtonIcon = require('../../../assets/icons/onboarding-play.png');
...
function TaskDetailsScreen({task, onBack, onContinue}) {
  ...
  return (
    <SafeAreaView style={styles.screen}>
      ...
      <View style={styles.header}>
        <Pressable accessibilityLabel="Back to tasks" hitSlop={12} onPress={onBack} style={styles.backButton}><Text style={styles.backArrow}>←</Text></Pressable>
        ...
        <View style={styles.heroCard}>
          <View style={styles.salonRow}>
            ...
            <View style={styles.salonCopy}>
              ...
              <Text style={styles.distance}>⌁  {task.activity}</Text>
            </View>
          </View>

          <View style={styles.primaryActions}>
            <Pressable accessibilityLabel={`Call ${task.name}`} accessibilityRole="button" onPress={handleCall} style={({pressed}) => [styles.primaryButton, pressed && styles.pressed]}><Image source={callButtonIcon} resizeMode="contain" style={styles.callButtonIcon} /><Text style={styles.primaryButtonText}>Call</Text></Pressable>
            <Pressable accessibilityLabel={`Navigate to ${task.name}`} accessibilityRole="button" onPress={handleNavigate} style={({pressed}) => [styles.secondaryButton, pressed && styles.pressed]}><Image source={navigateButtonIcon} resizeMode="contain" style={styles.navigateButtonIcon} /><Text style={styles.secondaryButtonText}>Navigate</Text></Pressable>
          </View>
          ...
          <View style={styles.mapWrap}>
            ...
            <Pressable accessibilityLabel={`Open ${task.name} in maps`} accessibilityRole="button" onPress={handleNavigate} style={({pressed}) => [styles.openMapButton, pressed && styles.pressed]}><Image source={externalLinkIcon} resizeMode="contain" style={styles.externalLinkIcon} /><Text style={styles.openMapText}>Open in Maps</Text></Pressable>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  headerTitle: {color: '#101735', fontSize: 15, fontWeight: '600', marginLeft: 2},
  ...
  salonName: {color: '#101735', fontSize: 16, fontWeight: '600'},
  ...
  distance: {color: '#17255B', fontSize: 9, marginTop: 5},
  ...
  primaryButtonText: {color: '#FFFFFF', fontSize: 11, fontWeight: '500'},
  ...
  metaLabel: {color: '#8B90A4', fontSize: 6.5},
  metaValue: {color: '#1E284F', fontSize: 7.5, fontWeight: '500', marginTop: 2},
  ...
  sectionTitle: {color: '#111936', fontSize: 14, fontWeight: '600', marginLeft: 9},
  infoRow: {height: 40, borderBottomWidth: 1, borderBottomColor: '#F0F1F5', flexDirection: 'row', alignItems: 'center'},
  infoLabel: {color: '#5D647D', fontSize: 10.5, marginLeft: 10},
  infoValue: {flex: 1, color: '#182246', fontSize: 10.5, fontWeight: '500', textAlign: 'right'},
  ...
  continueText: {color: '#FFFFFF', fontSize: 13, fontWeight: '500'},
