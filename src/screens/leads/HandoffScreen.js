...
const styles = StyleSheet.create({
  ...
  title: {color: '#10183D', fontSize: 19, fontWeight: '400'}, salon: {color: '#263052', fontSize: 12, fontWeight: '400', marginTop: 5},
  ...
  label: {color: '#141C40', fontSize: 12, fontWeight: '400', marginTop: 30, marginBottom: 8}, required: {color: '#F23F51'},
