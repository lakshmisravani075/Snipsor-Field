...
const styles = StyleSheet.create({
  ...
  headerText: {flex: 1}, title: {color: '#11183C', fontSize: 20, fontFamily: 'Poppins_600SemiBold'}, salon: {color: '#263052', fontSize: 13, fontFamily: 'Poppins_600SemiBold', marginTop: 4},
  ...
  cardTitle: {color: '#11183C', fontSize: 16, fontFamily: 'Poppins_600SemiBold'}, fieldsRow: {flexDirection: 'row', gap: 14, marginTop: 19, zIndex: 10}, dateColumn: {flex: 1.28, position: 'relative'}, timeColumn: {flex: 1, position: 'relative'}, openColumn: {zIndex: 20}, label: {color: '#171F43', fontSize: 13, fontFamily: 'Inter_500Medium', marginBottom: 7}, required: {color: '#F13F4E'},
